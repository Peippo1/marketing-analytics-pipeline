...
- Salesforce CRM push example
- HubSpot CRM push example
- Google Sheets synchronization example

## Delivery / Ops Assets

- Airflow DAGs for orchestration examples
- Dockerfiles for dashboard and API packaging
- Kubernetes manifests for deployment discussion and extension
